...
export const AnimalForm = (props) => {
    ...
    const { animals, addAnimal, updateAnimal, getAnimals } = useContext(AnimalContext)
    ...
    /* 
        If there is a URL parmeter, then the user has chosen to edit an animal.
...
//    Once the provider state is updated, dtermine the animal (if edit)
   useEffect(() => {
       getAnimalInEditMode()
   }, [animals])
